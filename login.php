      ...
      <div class="grid-x grid-padding-x" style="padding-top:10%;">
        ...
        <a class="large-4 medium-6 small-8 cell">
          ...
          <p class="text-center"><a href="#">Forgot your password?</a></p>
            ...
            <p style="padding-top:15%;"><a href="https://www.linkedin.com/start/join?trk=uno-reg-guest-home-join" <input type="submit" class="button expanded rit-orange" value="Register through LinkedIn"></input></p></a>
